function ResetForm() {
    $('#create-grrn-form').trigger("reset");
    $("#grrndetails-table tbody").find("tr:gt(0)").remove();
...
$(document).ready(function () {
    ...
    $('#create-grrn-form').submit(function (e) {
        e.preventDefault();
        FormIsValid = true;
        NonEmptyRowsCount = 0;
        ...
        if (FormIsValid && NonEmptyRowsCount !== 0) {
            var submitBtnId = 'btn-create-grrn';
            var submitToUrl = '/GoodsReturnNotes/Create';
            var formId = 'create-grrn-form';
