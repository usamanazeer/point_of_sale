bindSubmit('edit-modifier-form', 'btn-edit-modifier', '/Modifiers/Edit');
...
function ItemBarCodeSelect_OnChange(rowNo) {
    if (flag) {
        var ItemId = $("#InvModifierItems_" + rowNo + "__BarCodeId option:selected")[0].getAttribute('data-ItemId');
